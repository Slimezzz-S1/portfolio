...
export default function BuildWith() {
    ...
    return (
        <section ref={sectionRef} className='relative overflow-hidden h-196 flex flex-col lg:flex-row lg:justify-center items-center gap-12 p-10'>
          <h1 className='text-5xl lg:text-9xl text-center font-bold lg:font-black' style={{"transform" : "translateX(-100vw)"}}>
            Built with
          </h1>
